...
<html>
  <head>
    ...
    function onload()
    {
    	...
    	document.getElementById("selCount").value=0;
    }
...
{
	document.getElementById("error1").innerHTML="Please fill Company name field";
}
else
{
	document.getElementById("error1").innerHTML="";
}
if(document.getElementById("attCount").value=="")
{
	document.getElementById("error2").innerHTML="Please fill Attended count";
}
else
{
	document.getElementById("error2").innerHTML="";
}
if(document.getElementById("selCount").value=="")
{
	document.getElementById("error3").innerHTML="Please fill Selected count";
}
else
{
      ...
      <form action="/">
        ...
        <div class="personal-details">
          <div>
            ...
            <input  class="" type="text" name="name" placeholder="name" required onblur="chkblnk('name','error1')"/>
            <div class="col" style="color:red" id="error1"></div>
          </div>
		  <div>
            <label>Attended interview Count<span class="required">*</span></label>
            <input  class="" type="text" name="attCount" placeholder="Count" required/>
          </div>
		  <div>
            <label>Selected interview Count<span class="required">*</span></label>
            <input  class="" type="text" name="selCount" placeholder="Count" required/>
          </div>
		 <div>
       <fieldset>
        ...
        <div class="btn-block">
          <center><button type="submit" onclick="validate()"  href="/">Submit</button></center>
        </div>
      </form>
    </div>
  </body>
