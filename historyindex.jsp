	...
	<section class="single-course spad pb-0">
		<div class="container">
			<div class="course-meta-area">
				<div class="row">
					<div class="col-lg-10 offset-lg-1">
						<div class="course-note">Click here to View the Form</div>
						<h3>Campus Interviewing Detail</h3>
						<div class="course-metas">
							<div class="course-meta">
								<div class="course-author">
									<div class="ca-pic set-bg" data-setbg="img/authors/2.jpg"></div>
									<h6>Company Name</h6>
									<p>Tata Consultancy Services Limited (TCS), <span>Domain- Developer</span></p>
								</div>
							</div>
							<div class="course-meta">
								<div class="cm-info">
									<h6>Interviewing location</h6>
									<p>KGISL-College Saravanampatti,Coimbatore  <br>
									Student on the time at 9.30am. The interview process will starts from 10.30am <br>
									1 Round : Aptitude<br>2 Round : Technical<br>3 Round :Direct HR<br> </p>
								</div>
							</div>
							<div class="course-meta">
								<div class="cm-info">
							...
							<div class="course-meta">
								<div class="cm-info">
									<h6>Reviews</h6>
									<p>Company Reviews <span class="rating">
						...
						<a href="https://javatpoint.com/tcs-interview-questions" class="site-btn price-btn">TCS-</a>
						<a href="https://www.tcs.com/" class="site-btn buy-btn">TCS</a>
					</div>
				</div>
			</div>
